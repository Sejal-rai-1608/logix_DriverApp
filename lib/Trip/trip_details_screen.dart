...
class TripDetailsScreen extends StatelessWidget {
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    tripLocation(to, "Drop Off", "01:30 PM"),
                    ...
                    detailRow(Icons.route, "Distance", distance),

                    detailRow(Icons.wallet, "Payment", amount),

                    detailRow(Icons.inventory_2, "Load Type", "Electronics"),

                    detailRow(Icons.notes, "Notes", "Handle with care"),
                    ...
                    AuthButton(
                      ...
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) => OnTheWayScreen(trip: trip),
                          ),
                        );
                      },
                    ),
  ...
  Widget tripLocation(String city, String subtitle, String time) {
    return Row(
      children: [
        Container(
          width: 18,
